                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{url('admin/settings/post')}}" method="POST">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="country-floating">Bitcoin Address</label>
                                                <input type="text" id="country-floating" class="form-control @error('password') is-invalid @enderror"
                                                       name="btc" placeholder="" value="{{ $data->btc_address }}" required>
                                                @error('btc')
                                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="country-floating">Ethereum Address</label>
                                                <input type="text" id="country-floating" class="form-control @error('password') is-invalid @enderror"
                                                       name="eth" placeholder="" value="{{ $data->eth_address }}" required>
                                                @error('eth')
                                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="country-floating">Usdt Address</label>
                                                <input type="text" id="country-floating" class="form-control @error('password') is-invalid @enderror"
                                                       name="usdt" placeholder="" value="{{ $data->usdt_address }}" required>
                                                @error('usdt')
                                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="country-floating">Litecoin Address</label>
                                                <input type="text" id="country-floating" class="form-control @error('password') is-invalid @enderror"
                                                       name="ltc" placeholder="" value="{{ $data->ltc_address }}" required>
                                                @error('ltc')
                                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
